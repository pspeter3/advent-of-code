...
const parseStacks = (section: string): ReadonlyMap<number, ReadonlyArray<string>> => {
...
const clone = (stacks: ReadonlyMap<number, ReadonlyArray<string>>): Map<number, string[]> => {
...
const serialize = (inventory: ReadonlyMap<number, ReadonlyArray<string>>): string =>
