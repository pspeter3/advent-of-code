...
const fromRange = ([target, source, length]: AlmanacRange, value: number): number | null => {
...
const fromRangeList = (ranges: ReadonlyArray<AlmanacRange>, value: number): number => {
...
const fromMapList = (maps: ReadonlyArray<AlmanacMap>, value: number): number => {
  let result = value;
...
class NumericRange {
  static fromSeeds(seeds: ReadonlyArray<number>): ReadonlyArray<NumericRange> {
  ...
  static evolve(ranges: ReadonlyArray<NumericRange>, map: AlmanacMap): ReadonlyArray<NumericRange> {
