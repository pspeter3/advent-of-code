...
const CardinalDirectionListSchema = z
  ...
  .transform((directions) =>
    directions.map((direction) => Directions.indexOf(direction) as CardinalDirection),
  );

const parse = (input: string): CardinalDirectionList => CardinalDirectionListSchema.parse(input);
